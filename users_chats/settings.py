"""
Django settings for users_chats project.
...
INSTALLED_APPS = [
    ...
    'mychats.apps.MychatsConfig',
    'whachat.apps.WhachatConfig',
    'chating.apps.ChatingConfig',
    'channels',
    'crispy_forms',
    "crispy_bootstrap4",
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'posts.views.get_logged_in_user',
            ],
        },
    },
]
...
ASGI_APPLICATION = 'users_chats.asgi.application'
